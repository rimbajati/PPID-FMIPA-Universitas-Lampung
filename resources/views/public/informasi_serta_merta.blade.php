...
<div class="container mx-auto px-4 py-12 pt-32 max-w-7xl">
    ...
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-gray-900 mb-2">Informasi Diumumkan Serta Merta</h1>
        <p class="text-gray-600 max-w-2xl text-sm md:text-base">
            Daftar informasi yang berkaitan dengan hajat hidup orang banyak dan ketertiban umum yang harus diumumkan secara serta merta.
        </p>
    </div>

    <!-- Search Form -->
    <form id="searchForm" action="{{ url('/informasi-serta-merta') }}" method="GET" class="bg-white p-4 md:p-6 border border-gray-100 shadow-xl mb-8 flex flex-col md:flex-row gap-4 items-center rounded-3xl">
