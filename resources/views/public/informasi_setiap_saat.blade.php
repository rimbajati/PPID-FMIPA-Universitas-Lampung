...
<div class="relative bg-[#1B365D] text-white pt-32 sm:pt-40 pb-16 sm:pb-20 overflow-hidden mb-12">
    ...
    <div class="relative max-w-7xl mx-auto px-6 sm:px-8 md:px-16 lg:px-24">
        ...
        <nav class="flex flex-wrap items-center gap-2 text-xs sm:text-sm text-cyan-200 mb-6">
            ...
            <i class="fa-solid fa-chevron-right text-[10px]"></i>
            <span class="text-white font-bold">Informasi Tersedia Setiap Saat</span>
        </nav>
...
<div class="container mx-auto px-6 sm:px-8 md:px-16 lg:px-24 max-w-7xl pb-16">
    ...
    <!-- Search Form -->
    <form id="searchForm" action="{{ url('/informasi-setiap-saat') }}" method="GET" class="bg-white p-4 md:p-6 border border-gray-100 shadow-xl mb-8 flex flex-col md:flex-row gap-4 items-center rounded-3xl" onsubmit="event.preventDefault(); performLiveSearch(this);">
        <!-- Pagination Controls -->
