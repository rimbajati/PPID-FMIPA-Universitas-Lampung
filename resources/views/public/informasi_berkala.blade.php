...
<div class="container mx-auto px-6 sm:px-8 md:px-16 lg:px-24 max-w-7xl pt-10 sm:pt-12 pb-16">
    ...
    <form id="searchForm" action="{{ url('/informasi-berkala') }}" method="GET" class="mb-8 flex flex-col md:flex-row gap-3 items-center" onsubmit="event.preventDefault(); performLiveSearch(this);">
