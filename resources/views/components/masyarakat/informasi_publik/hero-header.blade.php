<!-- Header Hero Banner Katalog Informasi Publik (Biru Navy Unila #1B365D) -->
<section class="bg-gradient-to-br from-[#0B1E36] via-[#1B365D] to-[#0F2B52] text-white py-12 px-6 md:px-16 lg:px-24 relative overflow-hidden shadow-lg">
    <div class="max-w-7xl mx-auto space-y-6 relative z-10">
        ...
        <div class="flex items-center gap-2 text-xs md:text-sm text-slate-300 font-medium">
            ...
            <span class="text-white font-bold">Informasi Publik</span>
        </div>
        ...
        <div class="space-y-3 max-w-3xl">
            ...
            <p class="text-slate-200 text-sm md:text-base leading-relaxed font-medium">
                Akses seluruh informasi publik FMIPA Universitas Lampung yang telah diklasifikasikan sesuai UU KIP.
            </p>
        </div>
    </div>
</section>
