...
<main class="w-full bg-white border border-slate-200/90 rounded-3xl shadow-xl overflow-hidden">
    ...
    <form action="{{ url('/permohonan') }}" method="POST" enctype="multipart/form-data">
        ...
        <!-- SECTION HEADER UTAMA (Royal Sapphire Blue Header) -->
        <div class="bg-gradient-to-r from-blue-600 via-blue-600 to-blue-700 text-white p-6 md:p-8 flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs md:text-sm text-blue-100 font-medium mt-0.5">Tuliskan data diri dan detail permohonan informasi Anda dalam satu formulir ini.</p>
                </div>
            </div>
        </div>
        ...
        <div class="p-6 md:p-10 space-y-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
                ...
                <div class="space-y-5">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            ...
                            <select name="kategori_pemohon" x-model="selectedKategori" required
                                    class="w-full p-3.5 text-sm bg-slate-50/50 border border-slate-200 focus:border-blue-600 focus:ring-4 focus:ring-blue-100 focus:bg-white focus:outline-none transition rounded-2xl text-slate-800 font-semibold cursor-pointer">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 items-start">
                        <div>
                            <label class="block text-xs font-black text-slate-700 tracking-wide uppercase mb-2" for="no_identitas">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        ...
                        <div>
                            <label class="block text-xs font-black text-slate-700 tracking-wide uppercase mb-2" for="no_telepon">
                    ...
                    <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-3 items-stretch">
                            <div @click="cara_memperoleh = 'Dikirim melalui Email'"
                                 class="p-4 border-2 rounded-2xl flex items-center justify-center text-center gap-3 cursor-pointer transition-all h-full"
                                 :class="cara_memperoleh === 'Dikirim melalui Email' ? 'border-blue-600 bg-blue-50/70 text-blue-700 font-extrabold shadow-sm ring-2 ring-blue-100' : 'border-slate-200 hover:border-slate-300 text-slate-700 bg-white'">
                            ...
                            <div @click="cara_memperoleh = 'Datang langsung ke Dekanat FMIPA Universitas Lampung'"
                                 class="p-4 border-2 rounded-2xl flex items-center justify-center text-center gap-3 cursor-pointer transition-all h-full"
                                 :class="cara_memperoleh === 'Datang langsung ke Dekanat FMIPA Universitas Lampung' ? 'border-blue-600 bg-blue-50/70 text-blue-700 font-extrabold shadow-sm ring-2 ring-blue-100' : 'border-slate-200 hover:border-slate-300 text-slate-700 bg-white'">
            ...
            <div class="pt-6 border-t border-slate-200/80 flex flex-col sm:flex-row items-center justify-between gap-4">
                <label class="flex items-center gap-3 cursor-pointer bg-slate-50/80 p-4 rounded-2xl border border-slate-200/80 w-fit">
                    <input type="checkbox" x-model="disetujui" required class="w-4 h-4 text-blue-600 rounded focus:ring-blue-500 border-slate-300 shrink-0">
                ...
                <button type="submit" :disabled="!disetujui"
                        class="w-full sm:w-auto px-9 py-4 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-200 disabled:text-slate-400 disabled:shadow-none text-white text-xs md:text-sm font-extrabold transition rounded-full flex items-center justify-center gap-2 shadow-lg shadow-blue-600/25 hover:shadow-xl cursor-pointer shrink-0">
