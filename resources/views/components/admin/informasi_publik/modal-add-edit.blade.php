...
<div id="modalAddEdit" class="hidden fixed inset-0 z-[999999] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs transition-opacity">
        <div class="bg-white rounded-2xl max-w-2xl w-full shadow-2xl border-0 overflow-hidden animate-in fade-in zoom-in duration-200 flex flex-col max-h-[92vh]">
            ...
            <div class="bg-sky-500 text-white p-5 sm:p-6 flex items-center justify-between shrink-0 rounded-t-2xl w-full">
                <div>
                    ...
                    <p id="modalSubtitle" class="text-xs sm:text-sm text-white/90 font-medium mt-1 leading-normal">Isi data dibawah ini untuk menambahkan informasi baru</p>
                </div>
                <button type="button" onclick="closeAddEditModal()" class="w-9 h-9 rounded-xl bg-white/20 hover:bg-white/30 text-white flex items-center justify-center transition cursor-pointer shrink-0 ml-4">
