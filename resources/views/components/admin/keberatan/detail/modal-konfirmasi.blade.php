...
<template x-teleport="body">
    <div x-show="showConfirmModal" x-cloak 
        ...
        <div class="bg-white rounded-3xl p-7 sm:p-8 max-w-md w-full shadow-2xl space-y-6 text-center border border-slate-100 animate-in fade-in zoom-in duration-150"
            ...
            <div class="space-y-2">
                <h3 class="text-xl font-black text-slate-900 tracking-tight">Konfirmasi Status Keberatan</h3>
                <p class="text-sm text-slate-600 leading-relaxed font-medium">
                    ...
                    <span class="font-black px-2 py-0.5 rounded text-xs inline-block"
                          ...
                          x-text="statusSelect === 'Selesai' ? 'Selesai (Dikabulkan)' : statusSelect"></span>?
                </p>
                <p class="text-xs text-slate-400 font-medium pt-1">
                    Keputusan resmi ini akan diterbitkan kepada pemohon serta tercatat dalam riwayat sengketa informasi.
                </p>
            </div>
