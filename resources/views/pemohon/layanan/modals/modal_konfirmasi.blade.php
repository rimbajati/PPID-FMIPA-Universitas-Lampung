...
<div id="modal-confirm-submit" class="fixed inset-0 bg-slate-900/40 backdrop-blur-sm hidden z-[60] flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in duration-300">
        <div class="text-center">
            <div class="w-16 h-16 bg-cyan-50 text-[#1B365D] rounded-full flex items-center justify-center mx-auto mb-4 border border-cyan-100">
            ...
            <div class="flex gap-3">
                ...
                <button type="button" id="confirm-submit-btn" class="flex-1 py-3 bg-[#1B365D] hover:bg-[#1B365D] text-white rounded-xl font-bold transition shadow-md">Ya, Kirim</button>
            </div>
        </div>
    </div>
</div>
