...
<head>
    ...
    <title>Laporan Register Permohonan Informasi Publik - PPID FMIPA Unila</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 1.2cm;
...
<body>
    ...
    <div class="header">
        <h1>BUKU REGISTER PERMOHONAN INFORMASI PUBLIK</h1>
        ...
        <tbody>
            @forelse($items as $idx => $item)
                ...
                <tr>
                    ...
                    <td style="font-weight: 700; color: #0284c7;">{{ $item->no_tiket }}</td>
    ...
    <div class="footer">
        <div class="signature">
            ...
            <div style="font-weight: 700; margin-top: 4px;">Petugas Pelayanan Informasi (PPID)</div>
