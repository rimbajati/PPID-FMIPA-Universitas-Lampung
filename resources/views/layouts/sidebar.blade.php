            ...
            <div class="flex-1 overflow-y-auto flex flex-col">
                ...
                <nav class="px-6 space-y-2.5 mt-2">
                    <a href="{{ route('riwayat.index') }}"
                       ...
                       {{ request()->routeIs('riwayat.index') ? 'bg-[#0f172a] text-white shadow-lg shadow-slate-900/20' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-900' }}">
                        <i class="fa-solid fa-clock-rotate-left text-lg w-7 text-center mr-2"></i>
                        Riwayat Layanan
                    </a>
                    ...
                    <a href="{{ route('user.dashboard') }}"
                       class="flex items-center px-5 py-3.5 rounded-[14px] text-[15px] font-semibold transition-all duration-300
                       {{ request()->routeIs('user.dashboard') ? 'bg-[#0f172a] text-white shadow-lg shadow-slate-900/20' : 'text-slate-500 hover:bg-slate-100 hover:text-slate-900' }}">
