        ...
        <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-10 lg:gap-8">
            ...
            <div class="lg:col-span-4 space-y-4">
                <div class="flex items-center gap-2.5">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Logo PPID FMIPA Unila" class="h-8 w-auto object-contain">
                ...
                <div class="pt-4 text-xs text-slate-500 font-medium">
                    &copy; <?php echo e(date('Y')); ?> PPID FMIPA Unila. Semua hak dilindungi.
                </div>
            </div>
            ...
            <div class="lg:col-span-2 space-y-3">
                ...
                <ul class="space-y-3 text-xs">
                    <li>
                        <a href="<?php echo e(route('layanan.permohonan')); ?>" class="block hover:text-sky-600 transition-colors">
                    ...
                    <li>
                        <a href="<?php echo e(route('layanan.keberatan')); ?>" class="block hover:text-sky-600 transition-colors">
                    ...
                    <li>
                        <a href="<?php echo e(route('layanan.riwayat')); ?>" class="block hover:text-sky-600 transition-colors">
                    ...
                    <li>
                        <a href="<?php echo e(route('layanan')); ?>" class="block hover:text-sky-600 transition-colors">
            ...
            <div class="lg:col-span-2 space-y-3">
                ...
                <ul class="space-y-2.5 text-xs font-medium text-slate-600">
                    <li>
                        <a href="<?php echo e(route('informasi.publik', ['kategori' => 'Berkala'])); ?>" class="hover:text-sky-600 transition-colors">Informasi Berkala</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('informasi.publik', ['kategori' => 'Serta-Merta'])); ?>" class="hover:text-sky-600 transition-colors">Informasi Serta-Merta</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('informasi.publik', ['kategori' => 'Setiap Saat'])); ?>" class="hover:text-sky-600 transition-colors">Informasi Setiap Saat</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('informasi.publik')); ?>" class="hover:text-sky-600 transition-colors">Daftar Informasi Publik</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="lg:col-span-2 space-y-3">
                ...
                <ul class="space-y-2.5 text-xs font-medium text-slate-600">
                    <li>
                        <a href="<?php echo e(route('login')); ?>" class="hover:text-sky-600 transition-colors">Masuk Akun</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('register')); ?>" class="hover:text-sky-600 transition-colors">Pendaftaran Pemohon</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('password.request')); ?>" class="hover:text-sky-600 transition-colors">Lupa Kata Sandi</a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('beranda')); ?>" class="hover:text-sky-600 transition-colors">Beranda Utama</a>
                    </li>
                </ul>
            </div>
...
<?php /**PATH D:\laragon\www\ppid-fmipa-baru\resources\views/components/ui/footer.blade.php ENDPATH**/ ?>