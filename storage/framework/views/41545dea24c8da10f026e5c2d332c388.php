    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div class="relative shrink-0" x-data="{ openExport: false }">
            ...
            <div x-show="openExport" x-cloak 
                ...
                <a href="<?php echo e(route('admin.export.permohonan.excel', request()->query())); ?>" 
                ...
                <a href="<?php echo e(route('admin.export.permohonan.pdf', request()->query())); ?>" target="_blank"
    ...
    <div class="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3">
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
            <div class="p-4 sm:p-4.5 flex justify-between items-center min-h-[5.5rem]">
                <div>
                    <span class="text-3xl sm:text-4xl font-black block tracking-tight text-[#2563eb]"><?php echo e($totalPermohonan); ?></span>
            ...
            <div class="bg-[#2563eb] text-white text-[11px] font-bold px-3 py-1.5 flex items-center justify-between">
                <span class="truncate">Terakhir Masuk: <?php echo e($lastUpdateTotal ? \Carbon\Carbon::parse($lastUpdateTotal)->translatedFormat('d M Y') : '-'); ?></span>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
            <div class="p-4 sm:p-4.5 flex justify-between items-center min-h-[5.5rem]">
                <div>
                    <span class="text-3xl sm:text-4xl font-black block tracking-tight text-[#475569]"><?php echo e($totalMenunggu); ?></span>
            ...
            <div class="bg-[#475569] text-white text-[11px] font-bold px-3 py-1.5 flex items-center justify-between">
                <span class="truncate">Terakhir Masuk: <?php echo e($lastUpdateMenunggu ? \Carbon\Carbon::parse($lastUpdateMenunggu)->translatedFormat('d M Y') : '-'); ?></span>
                <i class="fa-solid fa-rotate text-[10px] shrink-0 ml-1"></i>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
            <div class="p-4 sm:p-4.5 flex justify-between items-center min-h-[5.5rem]">
                <div>
                    <span class="text-3xl sm:text-4xl font-black block tracking-tight text-orange-500"><?php echo e($totalDiproses); ?></span>
            ...
            <div class="bg-orange-500 text-white text-[11px] font-bold px-3 py-1.5 flex items-center justify-between">
                <span class="truncate">Terakhir Respon: <?php echo e($lastUpdateDiproses ? \Carbon\Carbon::parse($lastUpdateDiproses)->translatedFormat('d M Y') : '-'); ?></span>
                <i class="fa-solid fa-rotate text-[10px] shrink-0 ml-1"></i>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
            <div class="p-4 sm:p-4.5 flex justify-between items-center min-h-[5.5rem]">
                <div>
                    <span class="text-3xl sm:text-4xl font-black block tracking-tight text-[#059669]"><?php echo e($totalSelesai); ?></span>
            ...
            <div class="bg-[#059669] text-white text-[11px] font-bold px-3 py-1.5 flex items-center justify-between">
                <span class="truncate">Terakhir Respon: <?php echo e($lastUpdateSelesai ? \Carbon\Carbon::parse($lastUpdateSelesai)->translatedFormat('d M Y') : '-'); ?></span>
                <i class="fa-solid fa-rotate text-[10px] shrink-0 ml-1"></i>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-slate-200/80 shadow-xs overflow-hidden flex flex-col justify-between hover:shadow-md transition-shadow">
            <div class="p-4 sm:p-4.5 flex justify-between items-center min-h-[5.5rem]">
                <div>
                    <span class="text-3xl sm:text-4xl font-black block tracking-tight text-[#e11d48]"><?php echo e($totalDitolak); ?></span>
            ...
            <div class="bg-[#e11d48] text-white text-[11px] font-bold px-3 py-1.5 flex items-center justify-between">
                <span class="truncate">Terakhir Respon: <?php echo e($lastUpdateDitolak ? \Carbon\Carbon::parse($lastUpdateDitolak)->translatedFormat('d M Y') : '-'); ?></span>
                <i class="fa-solid fa-rotate text-[10px] shrink-0 ml-1"></i>
            </div>
        </div>
    </div>
</div>
<?php /**PATH D:\laragon\www\ppid-fmipa-baru\resources\views/components/admin/permohonan/summary-cards.blade.php ENDPATH**/ ?>